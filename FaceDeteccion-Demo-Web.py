...
def NatsFace():
    ...
    return jsonify({ "detections": {"Temperature": random2.choice(Temperature), "FaceDetector": {"confidence": random2.choice(confidence), "image_id": imageid, "label": 1,  "position": random2.choice(position), "size": random2.choice(size) , "LandmarksDetector": {"left_eye": [ 134,147], "left_lip_corner": [136,242],"nose_tip": [210,204 ], "right_eye": [300,145],"right_lip_corner": [307,240]}, "PoseEstimator": {"ypr": [-3.50416898727417, 3.2856898307800293,-0.45209193229675293] } },"FrameTimestamp":datetime.utcnow()}})
    #return jsonify (varr)
...
if __name__ == '__main__':
    app.run(host='192.168.100.215', port=5080, debug=True)